...
st.markdown("""
    <style>
    /* Appliquer un fond bleu clair + bordure à tous les blocs de gauche */
    ...
    /* Appliquer un fond jaune clair + bordure au bloc de droite */
    ...
    /* Forcer couleur noire des champs en thème sombre */
